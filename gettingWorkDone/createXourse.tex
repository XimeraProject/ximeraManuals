...
document, the names of the authors, a description of the content, a license, and
...
\end{document}
\end{verbatim}
Note how we give the paths to the exercises, it's the folder name, followed by
the document name. The \verb!.tex! can be left on if you like.
