...
\paragraph{\texttt{Git}} is program for version control. It allows many authors
to work on the same document without fear of
of overwriting others work.  If you are working with a collaborator, you
should always start your work off with
\begin{verbatim}
git pull
\end{verbatim}
