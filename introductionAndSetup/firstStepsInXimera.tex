...
\pdfOnly{\begin{multicols*}{2}}
        ...
        If you are simply playing with Ximera, you can just hit ``enter.''



        On the other hand, if you wish to deploy to a consistent site, 
        you should look at the section \textit{Deploying Ximera documents}.  
        \pdfOnly{\end{multicols*}}
