...
\pdfOnly{\begin{multicols*}{2}}
        ...
        in \verb!.vscode/!. Press the ``PDF'' button to compile Ximera content to a
        PDF. 
        \begin{itemize}
            \item The ``SERVE'' button to compiles the \textbf{entire} Ximera repository to HTML and deploys to a (local or remote) server. If this is the first time you are compiling, it will take a few minutes.
